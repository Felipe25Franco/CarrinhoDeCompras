...
public class TesteParte25 {
	...
	public static void main(String[] args) {
	        ...
	        double valorTotal1 = carrinho1.calcularValorTotal();
	        double valorTotal2 = carrinho2.calcularValorTotal();
	        ...
	        System.out.println("Data da venda: " + carrinho1.getDataVenda());
	        System.out.println("Valor total da venda: R$ " + valorTotal1);
	        System.out.println("\n\n");
	        
	        System.out.println("Data da venda: " + carrinho2.getDataVenda());
	        System.out.println("Valor total da venda: R$ " + valorTotal2);
	        System.out.println("\n\n");
